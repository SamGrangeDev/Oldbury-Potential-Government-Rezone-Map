...
//ol.proj.get("EPSG:7850").setExtent([390976.404529, 6425982.058680, 406915.960668, 6436977.210944]);
var wms_layers = [];
...
var format_Empty_31 = new ol.format.GeoJSON();
var features_Empty_31 = format_Empty_31.readFeatures(json_Empty_31, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7850'});
var jsonSource_Empty_31 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Empty_31.addFeatures(features_Empty_31);
var lyr_Empty_31 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Empty_31, 
                style: style_Empty_31,
                popuplayertitle: 'Empty',
                interactive: true,
                title: '<img src="styles/legend/Empty_31.png" /> Empty'
            });
